                ...
                <div class="product-details clearfix">
                    <div class="col-sm-8 col-md-6 col-xs-12 clearfix">
                        <form id="form-data">
                            ...
                            <div class="form-group">
                                <label class="fleft-label fleft-label-transport " for="mr-no-bill">MR No <span class="fright">:</span></label>
                                <input type="text" name="mr_no" class="form-control fright-input input-bill" id="mr-no-bill">
                            </div>
                    </div>
    ...
    $(document).ready(function(){
        ...
        $('#save-table').click(function(){
            ...
            '</div><!--end model body-->'+
                ...
                '<input name="mr_no" type="hidden" value="'+formObj['mr_no']+'">'+
        ...
        $('#final-submit').on('click', function(e){
            ...
            for(var k = 1; k < id_no; k++){
                $('#final-form'+k).on('submit', function(a){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo $this->Url->build(['Controller' => 'NonBillingDeliveryOrder', 'action' => 'addItems']); ?>',
                        data: formData,
                        dataType: 'text',
